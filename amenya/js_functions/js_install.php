<?php 
	...
	function js_check_users(){
      		if (!js_check_admin())  {
               	     die(JS_I_TOP.'CREATE AN ADMINISTRATOR'.JS_I_TOP_A.'<form js_page="'.js_new_admin().'" method="post">
    ...
    function js_check_functions(){
      if (!js_check_options())  {
               die(JS_I_TOP.'SITE OPTIONS'.JS_I_TOP_A.'<form js_page="'.js_new_options().'" method="post">
