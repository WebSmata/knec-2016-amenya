<?php include JS_THEME."js_header.php"; ?>
	<div id="site_content">	
	  ...
	  <div id="content">
		...
		<br>
		  <h1>Add an Books User</h1> 
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="PostUser" action="index.php?js_page=newuser" enctype="multipart/form-data" >
				...
				<tr>
					...
					<td><input type="password" autocomplete="off" name="passwordcon"></td>
                        ...
                        <center><input type="submit" class="submit_this" name="AddUser" value="Register Student"></center><br></form>
